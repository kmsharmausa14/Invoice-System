...
//        function validatedecimalpoint(txtchrge,txtunitprice)
//        {
//        var num = document.getElementById("txtlineamt").value;
//        var num1 = document.getElementById("txtunitprice").value;
//        debugger;
//        if(txtlineamt.length > 0)
//        {
//        var result = num.toFixed(2); 
//        }
//        if(txtunitprice.length > 0)
//        {
                                            ...
                                            <table w>
                                                ...
                                                <tr id="line_items" runat="server">
                                                    <td>
                                                                ...
                                                                <td>
                                                                    <table width="94%" cellpadding="5" style="font-family: Verdana; color: #006666; font-size: 12px;">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                                <b>
                                                                                    <asp:Label ID="lblRel" runat="server" Text="Release/Requisition Number:"></asp:Label></b>
                                                                                    <asp:Label
                                                        ...
                                                        <div style="overflow: auto; width: 1150px; height:100px"> 
                                                        ...
                                                        <table width="100%" align="center" style="backcolor: #F7F7F7">
                                                            <tr>
                                                                <td align="left" class="InvallSubheaders" width="100%">
                                                                    <b>Additional Charge Details [Optional]</b>
                                                                </td>
                                                            </tr>
                                                ...
                                                <tr id="acc_distr" runat="server">
                                                    <td>
                                                        ...
                                                        <table width="100%" align="center" style="backcolor: #F7F7F7">
                                                            <tr>
                                                                <td align="left" class="InvallSubheaders" colspan="8" width="100%">
                                                                    <b>Account Distribution Details [Optional]</b>
                                                                </td>
                                                            </tr>
