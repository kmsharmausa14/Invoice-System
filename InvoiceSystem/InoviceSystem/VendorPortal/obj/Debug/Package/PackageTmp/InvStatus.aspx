<%@ Page Title="Invoice Status" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="InvStatus.aspx.cs" Inherits="VendorPortal.InvStatus" %>

<%@ Register TagPrefix="ajax" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<asp:Content ID="ContentHeadInStatus" ContentPlaceHolderID="HeadContent" runat="server">
...
<asp:Content ID="ContentMainInvStatus" ContentPlaceHolderID="MainContent" ClientIDMode="Static"
    runat="server">
    <script type="text/javascript">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:LinkButton ID="LinkBtnSupplierCodeLookup2" runat="server" OnClick="LinkBtnSupplierCodeLookup2_Click"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddlStatus" Width="150px" Height="22px" runat="server" ToolTip="Status"
                                            TabIndex="6">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr style="width: 90%">
                                    <td width="90%" colspan="8" align="center">
                                        <asp:GridView ID="gvInvoiceStatus" runat="server" AutoGenerateColumns="false" Width="100%"
                                            ShowHeader="true" TabIndex="7" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvInvoiceStatus_PageIndexChanging">
                                            ...
                                            <Columns>
                                                <%--<asp:HyperLinkField AccessibleHeaderText="Invoice Number" HeaderText="Invoice #"
                                                    DataNavigateUrlFields="Inv_Code" DataNavigateUrlFormatString="~/ApproverScreen.aspx?QS_Inv_Code={0}&FlageFromInvStatus=yes"
                                                    DataTextField="Inv_Code" ></asp:HyperLinkField>--%>
                                                <asp:HyperLinkField AccessibleHeaderText="Invoice Number" HeaderText="Invoice #"
                                                    DataNavigateUrlFields="Inv_Code" DataNavigateUrlFormatString="~/CreateInvoice.aspx?QS_Inv_Code1={0}&FlageFromInvStatus=yes"
                                                ...
                                                <asp:TemplateField HeaderText="Approved/Rejected Date">
                                                    <ItemTemplate>
                                                        <%#Eval("modified_date")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                ...
                                <asp:GridView ID="grd_ViewSupplierCodeLookUp" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:HyperLinkField DataTextField="s_code" HeaderText="Supplier Code" DataNavigateUrlFields="s_code"
                                            DataNavigateUrlFormatString="~/InvStatus.aspx?QS_Scode={0}" ItemStyle-ForeColor="Black"
                                        ...
                                        <asp:HyperLinkField DataTextField="s_code" HeaderText="Supplier Code" DataNavigateUrlFields="s_code"
                                            DataNavigateUrlFormatString="~/InvStatus.aspx?QS_Scode1={0}" ItemStyle-ForeColor="Black"
                                            ControlStyle-ForeColor="Black" AccessibleHeaderText="s_code" Visible="False"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="White" />
                                        <asp:HyperLinkField DataTextField="s_code" HeaderText="Supplier Code" DataNavigateUrlFields="s_code"
                                            DataNavigateUrlFormatString="~/InvStatus.aspx?QS_Scode2={0}" ItemStyle-ForeColor="Black"
                                            ControlStyle-ForeColor="Black" AccessibleHeaderText="s_code" Visible="False"
                                            HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="White" />
                                        <asp:HyperLinkField DataTextField="s_code" HeaderText="Supplier Code" DataNavigateUrlFields="s_code"
    ...
    <ajax:ModalPopupExtender ID="MPE" runat="server" TargetControlID="LinkBtnSupplierCodeLookup2"
