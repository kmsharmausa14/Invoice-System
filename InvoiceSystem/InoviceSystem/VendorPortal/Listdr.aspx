<%@ Page Title="List of Draft" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Listdr.aspx.cs" Inherits="VendorPortal.Listdr" EnableEventValidation="false" %>

<%@ Register TagPrefix="ajax" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<asp:Content ID="ContentListdrHead" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="Scripts/jquery-1.4.1.js"></script>
    <script src="Scripts/jquery-1.4.1.min.js"></script>
    <style type="text/css">
        .modalBackgroundListDr
        {
    ...
    <script type="text/javascript">
        ...
        function ValidateTodateGreaterThanFromDate() {
            //debugger;
            //var textToDate = document.getElementById("txtToDate");
            var date = new Date();
...
<asp:Content ID="ContentListdrMain" ContentPlaceHolderID="MainContent" ClientIDMode="Static"
    runat="server">
    <asp:UpdatePanel ID="Updatepanel2" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <%#Eval("po_no") %>
            <table style="height: 570px; width: 100%" cellpadding="0" cellspacing="0" border="0"
                align="center" backcolor="#F7F7F7">
                <tr valign="top" align="center" style="font-family: Dotum; font-size: x-large; font-weight: bold;
                    ...
                    <td>
                        <table align="center" width="1000px" style="font-family: Verdana; color: #006666;
                                ...
                                <td width="100%">
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:TextBox ID="txtSupplierId" runat="server" ToolTip="Supplier Id" MaxLength="50"
                                                    TabIndex="1"></asp:TextBox>
                                                <script type="text/javascript">                                                    $("#txtSupplierId").ForAlphanumericNumericOnly();</script>
                                                <asp:LinkButton ID="LinkBtnSupplierCodeLookup" runat="server" OnClick="LinkBtnSupplierCodeLookup_Click"
                                                    CausesValidation="False">
                                        <img src="Images/Lookup.png" /></asp:LinkButton>
                                            </td>
                                            <td style="font-family: Verdana; font-size: 12px" align="left">
                                        ...
                                        <tr>
                                            <td colspan="8" align="center">
                                                <asp:GridView ID="gvListofDraft" runat="server" AutoGenerateColumns="false" Width="70%"
                                                    ShowHeader="true" TabIndex="7" AllowPaging="true" PageSize="5" OnPageIndexChanging="gvListofDraft_PageIndexChanging">
                                                    ...
                                                    <Columns>
                                                        <asp:HyperLinkField AccessibleHeaderText="Invoice Number" HeaderText="Invoice #"
                                                            DataNavigateUrlFields="Inv_Code" DataNavigateUrlFormatString="~/CreateInvoice.aspx?Inv_Code={0}&FlageFromListOfDraft=yes"
                                            ...
                                            <td align="center" colspan="8">
                                                <asp:Panel ID="pagingPanel" Visible="false" runat="server">
                                                    <table width="60%">
                                                        <tr>
                                                            <td style="width: 30%">
                                                                <asp:Label Text="Page Size" runat="server" ID="lblPageSize" />
                            ...
                            <tr align="center" style="width: 95%">
                                <td align="center" width="95%">
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function () {
                                            ...
                                            $('#txtPONo').ForAlphanumericNumericOnly();
                                            $('#txtInvoiceNumber').ForAlphanumericNumericOnly();
                                            $('#txtGoToPage').ForNumericOnly();
                                            $('#txtPageSize').ForNumericOnly();
                                        });
                                        var prm = Sys.WebForms.PageRequestManager.getInstance();
                ...
                <asp:Panel ID="pnlListDraft" runat="server" BorderColor="Black" BackColor="White"
                                ...
                                <table width="95%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                        <td height="30px" align="left">
                                            <asp:GridView ID="grd_ListDraftLookUp" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:HyperLinkField DataTextField="s_code" HeaderText="Supplier Code" DataNavigateUrlFields="s_code"
                                                        DataNavigateUrlFormatString="~/Listdr.aspx?QS_Scode={0}" ItemStyle-ForeColor="Black"
                                                    ...
                                                    <asp:HyperLinkField DataTextField="s_code" HeaderText="Supplier Code" DataNavigateUrlFields="s_code"
                                                        ...
                                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="White" />
                                                    <asp:HyperLinkField DataTextField="s_code" HeaderText="Supplier Code" DataNavigateUrlFields="s_code"
                                                        DataNavigateUrlFormatString="~/Listdr.aspx?QS_Scode2={0}" ItemStyle-ForeColor="Black"
                                                        ControlStyle-ForeColor="Black" AccessibleHeaderText="s_code" Visible="False"
                                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="White" />
                                                    <asp:HyperLinkField DataTextField="s_code" HeaderText="Supplier Code" DataNavigateUrlFields="s_code"
                                                        DataNavigateUrlFormatString="~/Listdr.aspx?QS_Scode3={0}" ItemStyle-ForeColor="Black"
                                                        ControlStyle-ForeColor="Black" AccessibleHeaderText="s_code" Visible="False"
                                                        HeaderStyle-HorizontalAlign="Left" ItemStyle-BackColor="White" />
                ...
                <ajax:ModalPopupExtender ID="MPEListDr" runat="server" TargetControlID="LinkBtnSupplierCodeLookup"
                    PopupControlID="pnlListDraft" BackgroundCssClass="modalBackgroundListDr" CancelControlID="btn_Cancel">
